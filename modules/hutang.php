...
$sql = "SELECT max(nomortransaksi_hutang) FROM hutang";
...
if ($transaksi) {
    ...
    $kode = $kode + 1;
    $auto_kode = "H" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
} else {
    $auto_kode = "H0001";
}
?>
...
<!-- ============================================================== -->
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Transaksi Hutang</h5>
                                                                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </a>
                                                                        <form action="../config/input_hutang.php" method="POST">
                                                            </div>
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="nomortransaksi_hutang" required="" readonly  value="<?php echo $auto_kode; ?>" class="form-control">
                                            </div>
                                        </div>
                                        </div>
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="date" name="tanggal_hutang"  required="" placeholder="" class="form-control">
                                        </div>
                                        </div>
                                        </div>
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="keterangan_hutang" required="" placeholder=""  class="form-control">
                                            </div>
                                        </div>
                                        </div>
                                                            <div class="modal-body">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="number" name="total_hutang"  required="" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-body">
                                                            <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right" for="akun_hutang">Akun</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Hutang</h2>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example4" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <?php
  $no =1;
  $ambil1 = mysqli_query($conn,"SELECT * FROM hutang inner join bagan_akun on hutang.id_baganakun=bagan_akun.id_baganakun");
  while ($data1 = mysqli_fetch_array($ambil1)) {
    ?>
  <tr>
    <td style="text-align:center;"><?php echo $no++;?></td> <!-- ini ID -->
    <td style="text-align:center;"><?php echo $data1['nomortransaksi_hutang'];?></td>
    <td style="text-align:center;"><?php echo $data1['tanggal_hutang'];?></td>
    <td style="text-align:left;"><?php echo $data1['keterangan_hutang'];?></td>
    <td style="text-align:center;"><?php echo "Rp ".number_format($data1['total_hutang'], 2, ",", ".");?></td>
    <td style="text-align:center;"><?php echo $data1['nama_akun'];?></td>
    <!-- <td style="text-align:center;">
        <a class="btn btn-rounded btn-warning" data-toggle="modal" data-target="#exampleModal<?=$data1['id_hutang'] ?>">Edit</a> | -->
      
                     <!-- ============================================================== -->
                        <!-- !!! MODAL !!! EDIT -->
                    <!-- ============================================================== -->
                    <?php $ambil3 = mysqli_query($conn,"SELECT * FROM hutang inner join bagan_akun on hutang.id_baganakun=bagan_akun.id_baganakun WHERE hutang.id_hutang='$data1[id_hutang]'");
                    $data3 = mysqli_fetch_array($ambil3);  ?>
                    <div class="modal fade" id="exampleModal<?=$data3['id_hutang'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">

                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel2">Edit Data hutang</h5>
                                                                <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </a>
                                                            </div>                   
                                                            ...
                                                            <input type="text" hidden="" required="" placeholder="" name="idnya" class="form-control" value="<?php echo $data3['id_hutang']?>" >

                                                            <div class="modal-body">
                                                            <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right" for="tanggal_hutang">Tanggal</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="date" required="" placeholder="" name="tanggal_hutang" class="form-control" value="<?=$data3['tanggal_hutang'] ?>" >
                                                            ...
                                                            <div class="modal-body">
                                                            <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right" for="keterangan_hutang">Keterangan</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" required="" placeholder="" name="keterangan_hutang" class="form-control" value="<?=$data3['keterangan_hutang'] ?>" >
                                                            ...
                                                            <div class="modal-body">
                                                            <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right" for="total_hutang">Total</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="number" required="" placeholder="" name="total_hutang" value="<?=$data3['total_hutang'] ?>" class="form-control">
                                            </div>
                                        </div>
                                                            </div>
                                            ...
                                            <select name="id_baganakun" class="form-control">
                                                            <?php
  $amb = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM hutang WHERE id_baganakun='$data3[id_baganakun]'"));
  ...
  <?php }?>
        ...
        <!-- <a class="btn btn-rounded btn-danger" href="../config/hapus_hutang.php?id_hutang=<?php echo $data1['id_hutang']?>" onclick="return confirm('Yakin anda ingin hapus?')">Hapus</a>      -->
    </td>
  </tr>
  <?php
  }
  ?>
                                    ...
                                    <p><p>Total Transaksi Hutang : <?php echo mysqli_num_rows($ambil1) ?></p></p>

                                   <div align="right">   <a href="../modules/cetakhutang.php" class="btn btn-info">Cetak Transaksi Hutang</a> </div> 
                                </div>
                            </div>
                        </div>
                    </div>
...
if(isset($_POST['save'])){
    $id = $_POST['idnya'];
$tgl = $_POST['tanggal_hutang'];
$ket = $_POST['keterangan_hutang'];
$tot = $_POST['total_hutang'];
$akun = $_POST['akun_hutang'];
$id_baganakun = $_POST['id_baganakun'];

// buat query 
$sql = "UPDATE hutang SET tanggal_hutang='$tgl', keterangan_hutang='$ket', total_hutang='$tot', akun_hutang='$akun',id_baganakun='$id_baganakun' WHERE id_hutang='$id'";
$query = mysqli_query($conn, $sql);
