                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="">
									  ...
									  <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Akun</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                              <button type="button" data-toggle="dropdown" class="btn btn-secondary dropdown-toggle">Nama akun</button>
												 <div class="dropdown-menu">
													 <a href="#" class="dropdown-item">Beban Listrik</a>
													 <a href="#" class="dropdown-item">Beban Air</a>
													 <a href="#" class="dropdown-item">Beban Telepon</a>
													 <a href="#" class="dropdown-item">Beban Wifi</a>
													 <a href="#" class="dropdown-item">Beban Gaji dan Komisi</a>
													 <a href="#" class="dropdown-item">Beban Bunga</a>
													 <a href="#" class="dropdown-item">Hutang Bank</a>
													 <a href="#" class="dropdown-item">Hutang Dagang</a>
                                            </div>
                                        </div>
</div>
